...
"""
    Adapted from pygments.cmdline

    Returns formatter, lexer and possibly code deduced from given arguments
...
def process(args):
    ...
    try:
        ...
        # No outfile given means that we wanted to have highlighted code returned
        if outfn:
